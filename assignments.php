...
<body className='snippet-body'>
    ...
    <body id="body-pd">
        ...
        <main>
            <h2 class="Assignment-title">Assignment 2</h2>
            ...
            <div class="height-100 bg-light">
                <div id="Assignment1">
                    ...
                    <div class="height-100 bg-light">
                        <h2 class="Assignment-title">Assignment 1</h2>
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">I really enjoy web development, and designing websites.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                    data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">I would like to become a web developer after graduating.
                                        Although PHP is
                                        a
                                        little outdated, another language under my
                                        belt is never a bad thing.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseThree" class="accordion-collapse collapse"
                                    data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body"><a href="https://github.com/SaMoBTW/CS3270"
                                            target="_blank"><button type="button" class="btn btn-primary github-btn"><i
                                                    class='bx bxl-github nav_icon'></i></button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
